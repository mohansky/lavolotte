    ...
    return (
      <Html lang="de">
        <Head>
          ...
          <meta property="og:description" content={`Die bezaubernde, alte Ladentür öffnet sich zu 'La Volotte', und ein charmantes, kleines Geschäft mit einer großen Auswahl an ausgesuchten, hochwertigen Naturgarnen aus verschiedenen Ländern lädt die Kundschaft zum Schwelgen und Finden ein! | ${CMS_NAME}.`}/>
