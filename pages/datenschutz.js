    ...
    <div className="container">
      <div className="col-12 mb-5">
        ...
        <p>
          ...
          Angabe gemacht wird. &ldquo;Personenbezogene Daten&rdquo; sind alle
        ...
        <p>
          ...
          gespeichert. Zu diesen gespeicherten Daten gehören z.B. der Name der
          ...
          überwiegenden berechtigten Interesse an der Gewährleistung eines
        ...
        <p>
          Initiativ-Kontaktaufnahme des Kunden per E-Mail Wenn Sie per E-Mail
          initiativ mit uns in Geschäftskontakt treten, erheben wir Ihre
          ...
          dient der Bearbeitung und Beantwortung Ihrer Kontaktanfrage. Wenn die
          Kontaktaufnahme der Durchführung vorvertraglichen Maßnahmen (bspw.
          Beratung bei Kaufinteresse, Angebotserstellung) dient oder einen
          ...
          betreffender personenbezogener Daten zu widersprechen. Ihre
          ...
          Verarbeitung und Nutzung nicht zugestimmt haben. Erhebung und
          Verarbeitung bei Nutzung des Kontaktformulars Bei der Nutzung des
          Kontaktformulars erheben wir Ihre personenbezogenen Daten (Name,
          E-Mail-Adresse, Nachrichtentext) nur in dem von Ihnen zur Verfügung
          gestellten Umfang. Die Datenverarbeitung dient dem Zweck der
          Kontaktaufnahme. Wenn die Kontaktaufnahme der Durchführung
        ...
        <p>
          Verwendung von PayPal Alle PayPal-Transaktionen unterliegen der
        ...
        <p>
          ...
          Grundlage des § 25 Abs. 2 TTDSG. Die Verarbeitung Ihrer
          ...
          ergeben, jederzeit dieser Verarbeitungen Sie betreffender
          personenbezogener Daten zu widersprechen. Verwendung von
          Consentmanager Wir verwenden auf unserer Website das
          Consent-Management-Tool Consentmanager der Consentmanager AB
          (Håltegelvägen 1b, 72348 Västerås, Schweden;
          &ldquo;Consentmanager&rdquo;). Das Tool ermöglicht es Ihnen,
          Einwilligungen in Datenverarbeitungen über die Website, insbesondere
          das Setzen von Cookies, zu erteilen sowie von Ihrem Widerrufsrecht für
          bereits erteilte Einwilligungen Gebrauch zu machen. Die
          Datenverarbeitung dient dem Zweck, erforderliche Einwilligungen in
          Datenverarbeitungen einzuholen sowie zu dokumentieren und damit
          gesetzliche Verpflichtungen einzuhalten. Hierzu können Cookies
          eingesetzt werden. Dabei können u. a. folgende Informationen erhoben
          und an Consentmanager übermittelt werden: Datum und Uhrzeit des
          Seitenaufrufs, Informationen zu dem von Ihnen verwendeten Browser und
          das von Ihnen genutzte Gerät, anonymisierte IP-Adresse, Opt-in- und
          Opt-out-Daten. Eine Weitergabe dieser Daten an sonstige Dritte erfolgt
          nicht. Die Datenverarbeitung erfolgt zur Erfüllung einer rechtlichen
          Verpflichtung auf Grundlage des Art. 6 Abs. 1 lit. c DSGVO. Nähere
          Informationen zum Datenschutz bei Consentmanager finden Sie unter:{" "}
          <a href="https://www.consentmanager.net/privacy.php">
          ...
          ) Verwendung des Cookie Hinweises von MND Next Wir verwenden auf
          unserer Website das Plug-in Cookie Hinweis mit Opt-In/Opt-Out der MDN
          Next GmbH (Robert-Bosch-Straße 8, 73037 Göppingen; &ldquo;MDN
          Next&rdquo;). Das Plug-in ermöglicht es Ihnen, Einwilligungen in
          Datenverarbeitungen über die Website, insbesondere das Setzen von
          Cookies, zu erteilen sowie von Ihrem Widerrufsrecht für bereits
          erteilte Einwilligungen Gebrauch zu machen. Die Datenverarbeitung
          dient dem Zweck, erforderliche Einwilligungen in Datenverarbeitungen
          einzuholen sowie zu dokumentieren und damit gesetzliche
          Verpflichtungen einzuhalten. Hierzu werden Cookies eingesetzt, mit
          denen Ihr Einwilligungsstatus gespeichert wird. Die Datenverarbeitung
          erfolgt zur Erfüllung einer rechtlichen Verpflichtung auf Grundlage
          des Art. 6 Abs. 1 lit. c DSGVO. Nähere Informationen zum Datenschutz
          bei MDN Next finden Sie unter:{" "}
          <a href="https://www.mndnext.de/impressum/">
            https://www.mndnext.de/impressum/
          </a>{" "}
          (
          <a href="https://www.mndnext.de/impressum/)">
            https://www.mndnext.de/impressum/)
        ...
        <p>
          ...
          CA 94043, USA; &ldquo;Google&rdquo;). Soweit Sie Ihren gewöhnlichen
          ...
          Datenschutzgesetze verantwortlich ist. Die Datenverarbeitung dient dem
          Zweck der Analyse dieser Website und ihrer Besucher sowie für
          Marketing- und Werbezwecke. Dazu wird Google im Auftrag des Betreibers
          ...
          Websitebetreiber zu erbringen. Dabei können u.a. folgende
          ...
          Referrer-URL (Webseite, über die Sie unsere Webseite aufgerufen
          haben), Standortdaten, Kaufaktivitäten. Die im Rahmen von Google
          Analytics von Ihrem Browser übermittelte IP-Adresse wird nicht mit
          anderen Daten von Google zusammengeführt. Google Analytics verwendet
          Technologien wie Cookies, Webspeicher im Browser und Zählpixel, die
          eine Analyse der Benutzung der Website durch Sie ermöglichen. Die
          dadurch erzeugten Informationen über Ihre Benutzung dieser Website
          werden in der Regel an einen Server von Google in den USA übertragen
          und dort gespeichert. Für die USA ist kein Angemessenheitsbeschluss
          der EU-Kommission vorhanden. Die Datenübermittlung erfolgt u.a auf
          Grundlage von Standardvertragsklauseln als geeignete Garantien für den
          Schutz der personenbezogenen Daten, einsehbar unter:{" "}
          ...
          Ihnen vorliegen hat, verknüpft werden. Auf dieser Website ist die
          ...
          Erfassung der durch Google Analytics erzeugten und auf Ihre Nutzung
          der Website bezogenen Daten (inkl. Ihrer IP-Adresse) an Google sowie
          die Verarbeitung dieser Daten durch Google verhindern, indem Sie das
          unter dem folgenden Link verfügbare Browser-Plug-in herunterladen und
          installieren:{" "}
          ...
          gesetzt: Google Analytics deaktivieren (javascript:gaOptout()). Nähere
        ...
        <p>
          ...
          &ldquo;Google&rdquo;). Soweit Sie Ihren gewöhnlichen Aufenthalt im
          ...
          der Optimierung unserer Website. Der Google Tag Manager selbst
          speichert weder Cookies noch werden hierdurch personenbezogene Daten
          verarbeitet. Er ermöglicht jedoch die Auslösung weiterer Tags, die
          personenbezogene Daten erheben und verarbeiten können. Nähere
        ...
        <p>
          Dauer der Speicherung Nach vollständiger Vertragsabwicklung werden die
          ...
          Fristablauf gelöscht, sofern Sie der weitergehenden Verarbeitung und
          Nutzung nicht zugestimmt haben.
        </p>
        <p>
          Rechte der betroffenen Person Ihnen stehen bei Vorliegen der
          gesetzlichen Voraussetzungen folgende Rechte nach Art. 15 bis 20 DSGVO
          zu: Recht auf Auskunft, auf Berichtigung, auf Löschung, auf
          Einschränkung der Verarbeitung, auf Datenübertragbarkeit. Außerdem
          steht Ihnen nach Art. 21 Abs. 1 DSGVO ein Widerspruchsrecht gegen die
          Verarbeitungen zu, die auf Art. 6 Abs. 1 f DSGVO beruhen, sowie gegen
          die Verarbeitung zum Zwecke von Direktwerbung.
        </p>
        <p>
          Beschwerderecht bei der Aufsichtsbehörde Sie haben gemäß Art. 77 DSGVO
          das Recht, sich bei der Aufsichtsbehörde zu beschweren, wenn Sie der
