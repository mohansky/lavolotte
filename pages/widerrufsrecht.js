        ...
        <div className="row">
          <div className="col-12 mb-5">
            <div className="content">
              ...
              <p>
                Widerrufsrecht Sie haben das Recht, binnen 14 Tagen ohne Angabe
              ...
              <ul>
                <li>
                  <p>
                    ...
                    der Beförderer ist, die Waren in Besitz genommen haben bzw.
                    hat, sofern Sie eine oder mehrere Waren im Rahmen einer
                    einheitlichen Bestellung bestellt haben und diese
                ...
                <li>
                  <p>
                    an dem Sie oder ein von Ihnen benannter Dritter, der nicht
                    der Beförderer ist, die letzte Ware in Besitz genommen haben
                    bzw. hat, sofern Sie mehrere Waren im Rahmen einer
                    einheitlichen Bestellung bestellt haben und diese getrennt
                    geliefert werden;
                  </p>
                </li>
              </ul>
              <p>
                Um Ihr Widerrufsrecht auszuüben, müssen Sie uns (La Volotte -
                Münz und Kreuzer GbR, Jakobstrasse 107, 52064 Aachen,
                Telefonnr.: 0241 47587794, E-Mail-Adresse:{" "}
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Tage nach Vertragsschluss geliefert werden können und deren
                    aktueller Wert von Schwankungen auf dem Markt abhängt, auf
              ...
              <ul>
                <li>
                  <p>
                    An La Volotte - Münz und Kreuzer GbR, Jakobstrasse 107,
                    52064 Aachen, E-Mail-Adresse:{" "}
                    <a href="mailto:wolle@la-volotte.de">wolle@la-volotte.de</a>{" "}
                    :
                  </p>
                </li>
                <li>
                  <p>
                    Hiermit widerrufe(n) ich/ wir (<em>) den von mir/ uns (</em>
                    ) abgeschlossenen Vertrag über den Kauf der folgenden Waren
                    (<em>)/ die Erbringung der folgenden Dienstleistung (</em>)
                  </p>
                </li>
                <li>
                  <p>
                    Bestellt am (<em>)/ erhalten am (</em>)
                  </p>
                </li>
                <li>
